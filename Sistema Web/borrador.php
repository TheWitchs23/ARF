...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-3 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">OCI.</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Jefe de Carrera</a>
                        <a class="collapse-item" href="">Docente</a>
                        <a class="collapse-item" href="registro.php">Alumno</a>
            ...
            <!-- Nav Item - Charts -->
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCharts"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Calendario Escolar</a>

                        <a class="collapse-item" href="borrador.php">Horario de Clases</a>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h6 class="m-0">UNIVERSIDAD TECNOLÓGICA DEL SUR DEL ESTADO DE MORELOS</h6>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h6 class="card-title">Asistencia por Reconocimiento Facial</h6>
              </div>
              <div class="card-body">
                <p><img src="img/horario.jpg" class="img-fluid" width="90%"></p>
              </div>
            </div>
          </div>
        </div>
